# NeetCode Solutions — @brapper13

> Synced automatically from [NeetCode.io](https://neetcode.io) · Repository: `neetcode-submissions`

---

## Study material (the real content)

The solutions here are auto-synced by NeetCode. The written material around
them is the point of the repo:

- [TAKEAWAYS.md](TAKEAWAYS.md) — the rules each problem taught, linked to
  the exact lines of code.
- [PLAYBOOK.md](PLAYBOOK.md) — the pre-problem ritual and how to match a
  problem to a technique.
- [go-notes/](go-notes/) — deep dives on Go itself: strings, map keys,
  defer, closures, map internals.
- Each problem folder has a `STATEMENT.md` (what the problem asks) and a
  `NOTES.md` (review of the submissions).
